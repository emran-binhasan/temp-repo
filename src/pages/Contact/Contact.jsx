...
const Contact = () => {
	...
	return (
		<div className="">
			...
			<div className="grid grid-cols-1 mx-4 mt-16 lg:mx-32 lg:grid-cols-2 gap-x-20 lg:gap-x-28 gap-y-16">
				<div>
				...
				<div className="p-2 border rounded-xl">
					<iframe
						className="w-full h-[450px] max-w-full lg:w-[600px]"
						src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d58416.349262976255!2d90.416531!3d23.782237!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c7e98e569ff7%3A0x611b923fdc589964!2sBay&#39;s%20Galleria!5e0!3m2!1sen!2sbd!4v1739202081887!5m2!1sen!2sbd"
						allowfullscreen=""
						loading="lazy"
